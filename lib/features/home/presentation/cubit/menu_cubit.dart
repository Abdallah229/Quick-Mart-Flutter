...
class MenuCubit extends Cubit<MenuState> {
  ...
  /// Fetches a paginated list of home items.
  ///
  ...
  /// Searches the home for a specific text query.
  ///
  ...
  Future<void> clearSearch() async {
    ...
    ); // Reload the standard category grid
  }
      ...
      result.fold(
        ...
        (filteredResult) => emit(
          state.copyWith(
            status: RequestState.success,
            products: filteredResult,
            hasReachedMax: filteredResult.isEmpty,
          ),
        ),
      );
    }
